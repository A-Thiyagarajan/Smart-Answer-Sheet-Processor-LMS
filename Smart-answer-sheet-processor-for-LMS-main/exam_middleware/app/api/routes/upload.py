...
async def upload_single_file(
    ...
    try:
        ...
        await audit_service.log_action(
            ...
            request_data={"filename": file.filename, "size": metadata.get("size_bytes"), "exam_session": normalized_exam_session}
        )
        
        await db.commit()
        
        subject_code, artifact_exam_session = split_subject_session_key(artifact.parsed_subject_code)
        return FileUploadResponse(
            success=True,
            ...
            exam_session=artifact_exam_session,
...
async def upload_bulk_files(
    ...
    await audit_service.log_action(
        ...
        request_data={"total": len(files), "successful": successful, "failed": failed, "exam_session": normalized_exam_session}
    )
